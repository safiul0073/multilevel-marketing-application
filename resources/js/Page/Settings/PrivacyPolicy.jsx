...
const PrivacyPolicy = () => {
    ...
    const {isLoading, data: optionValue, refetch} = getOptionValueByName('mlm_privacy_policy')
                    ...
                    <main className="flex-1 py-8">
                        <div className="container">
                            <div className="my-4 py-2 px-2 w-full border border-gray-500 mx-auto">
                                <div className="mx-2">
                                    <p className="text-center py-4 text-gray-600 font-bold">Set Privacy Policy for your site</p>
                                </div>
                                <hr />
                                <div className="my-2">
                                    <label className="block text-sm font-medium text-gray-700 pr-8">Privacy Policy</label>
                                    <JoditEditor
                                    ref={editor}
                                    value={content}
                                    config={
...
export default Protected(memo(PrivacyPolicy));
