...
const Details = ({ userId }) => {
    const {data: details} = userDetails({id: userId})
    const projects = [
        {
            name: "Total Balance",
            count: details?.balance,
            suffix: "TK",
            initials: "TB",
        ...
        },
        {
            ...
            count: details?.total_transaction,
            suffix: "",
            initials: "TT",
            bgColor: "bg-gray-800",
        },
