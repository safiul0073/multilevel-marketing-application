...
const Balance = ({ details }) => {
    ...
    const projects = [
        {
            name: "Total Balance",
            count: (details?.balance || 0.000).toFixed(2),
            suffix: "TK",
            initials: "TB",
        ...
        {
            name: "Total Withdraw",
            count: (details?.total_withdraw || 0.000).toFixed(2),
            suffix: "TK",
            initials: "TW",
            bgColor: "bg-rose-600",
        },
        {
            ...
            count: (details?.purchase_amount || 0.000).toFixed(2),
            suffix: "",
            initials: "PP",
            bgColor: "bg-gray-800",
        },
        {
            ...
            count: (details?.total_today_bonus || 0.000).toFixed(2),
            suffix: "TK",
            initials: "TDC",
            bgColor: "bg-sky-500",
        },
        {
            ...
            count: details?.referral_bonus || 0.000,
            suffix: "TK",
            initials: "TRC",
        ...
        },
        {
            ...
            count: details?.matching_bonus || 0.000,
            suffix: "TK",
            initials: "TMC",
        ...
        },
        {
            ...
            count: details?.left_group || 0.000,
            suffix: "",
            initials: "TLM",
            bgColor: "bg-gray-800",
        },
        {
            ...
            count: details?.right_group || 0.000,
            suffix: "",
            initials: "TRM",
