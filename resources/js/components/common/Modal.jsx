...
export default function Modal({isOpen, setIsOpen, closeModal, title, children, button}) {
                        ...
                        <div className='px-6'>
                            <form onSubmit={handleSubmit(onSubmit)}>
                                <div className="grid grid-cols-1 gap-4">
                                    <div>
                                        <label className=" input-label" htmlFor="email">Name</label>
                                        <input className='input-control' id="name" {...register('name', { required: true })} />
