...
<div class="grid gird-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-7">
    <div class="flex w-full items-center rounded-md bg-green-500 p-4 shadow-xl shadow-black/5 ring-1 ring-slate-700/10">
        <svg class="h-16 w-16 flex-none text-gray-400" viewBox="0 0 40 40" fill="none">
    ...
    <div class="flex w-full items-center rounded-md bg-fuchsia-600 p-4 shadow-xl shadow-black/5 ring-1 ring-slate-700/10">
        ...
        <div class="flex flex-col ml-5">
            ...
            <h3 class="text-3xl">{{ $user->gen_bonus }}</h3>
        </div>
    </div>
